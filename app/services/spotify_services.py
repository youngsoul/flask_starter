...
#    track_list = soup.find('li', attrs={'class': "tracklist-row js-track-row tracklist-row--track track-has-preview preview-strategy track-playback-enabled"})
    ...
    for track in track_list:
        ...
        # print(track_name)
        artists_albums = track.find('span', attrs={'class':'artists-albums'}).findAll('a')
        ...
        top_30.append(SpotifyTop30(artist=artist, album=album, song=track_name, duration=duration))
