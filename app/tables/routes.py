...
@login_required
def tables():
    top_30_songs_url = current_app.config['spotify_top_30_url'] if 'spotify_top_30_url' in current_app.config else 'https://open.spotify.com/user/thesoundsofspotify/playlist/1z1LfuAoQQDRKLOyVQvaRa'
    top_30_songs = get_top_30(top_30_songs_url)
    print(top_30_songs)
    return render_template('tables/tables.html', table_title="Spotify Top 30 Jam", data=top_30_songs)
